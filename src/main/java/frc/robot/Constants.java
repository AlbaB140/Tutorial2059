...
public final class Constants {
  ...
  public static final class DrivetrainConstants {
    ...
    public static final double ksVolts = 0.129;
    public static final double kvVoltSecondsPerMeter = 3.34;
    public static final double kaVoltSecondsSquaredPerMeter = 1.04;
    public static final double kPDriveVel = 2.27;
